...
export interface LocalizedTitle {
  title_ar: string; title_en: string; title_he: string;
...
export interface GalleryDto extends Timestamped, ActiveSortable {
  id: number; image_url: string; title_ar: string | null; title_en: string | null; title_he: string | null;
  alt_text_ar: string | null; alt_text_en: string | null; alt_text_he: string | null; category: string | null;
}
export interface PartnerDto extends Timestamped, ActiveSortable { id: number; name_ar: string; name_en: string; name_he: string; logo_url: string; website_url: string | null }
export interface TestimonialDto extends Timestamped, ActiveSortable {
  id: number; client_name_ar: string; client_name_en: string; client_name_he: string;
  message_ar: string; message_en: string; message_he: string;
  client_position_ar: string | null; client_position_en: string | null; client_position_he: string | null;
}
