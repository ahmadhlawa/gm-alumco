import type { Partner, Project, Service, Testimonial } from '@/types';
import type { Locale, PartnerDto, ProjectDto, ServiceDto, SiteContentDto, TestimonialDto } from './types';
