...
export function CTASection({
  ...
  const finalTitle = title || t("האם יש לך פרויקט חדש? תן לנו לעזור לך לממש אותו.", "Have a new project? Let us help you bring it to life.");
  const finalSubtitle = subtitle || t("אנו כאן לייעוץ הנדסי והצעות מחיר תחרותיות לפרויקט הבא שלך.", "We're here to provide engineering consultation and competitive quotes for your next project.");
  const finalButtonText = buttonText || t("צור קשר עכשיו", "Contact us now");
