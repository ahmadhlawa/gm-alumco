...
export function About() {
  ...
  return (
    <div className="bg-brand-surface">
      <PageHero 
        title={t("عن GM Alomco", "על GM Alomco")}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            >
              ...
              <p className="text-brand-silver mb-6 leading-relaxed text-lg">
                {t('تأسست شركة GM Alomco برؤية واضحة تهدف إلى إحداث نقلة نوعية في صناعة الواجهات الزجاجية وأنظمة الألمنيوم في المنطقة. منذ اليوم الأول، ركزنا على الجودة الفائقة، والالتزام بالمعايير الهندسية الدقيقة، واحترام مواعيد تسليم المشاريع.', 'GM Alomco הוקמה בחזון ברור לחולל שינוי מהותי בתעשיית קירוי מבנים ומערכות אלומיניום.')}
              </p>
