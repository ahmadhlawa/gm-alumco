...
const COPY = {
  he: {
    ...
    confirmDelete: (name: string) => `מחיקת פרויקט הייצור "${name}" היא קבועה ואי אפשר לבטל אותה. להמשיך?`,
  ...
  en: {
    ...
    confirmDelete: (name: string) => `Permanently delete the production project "${name}"? This cannot be undone.`,
