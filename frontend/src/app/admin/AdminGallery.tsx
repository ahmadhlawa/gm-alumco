...
const fields = [
  ...
  { key: 'url', label: 'رابط الصورة', type: 'text' as const }
];
...
export function AdminGallery() {
  ...
  const uploadGalleryImage = async (url: string) => {
    await createGalleryImage({ image_url: url });
    await load();
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <ImageUploadField label="رفع صورة جديدة إلى المعرض" folder="gallery" onUploaded={uploadGalleryImage} />
