...
export function AdminPartners() {
  ...
  return <div className="space-y-6">
    <AdminPageHeader title="الشركاء" description="إدارة شعارات وروابط شركاء T.A.S." action={<Link to="/admin/partners/new" className="flex items-center gap-2 rounded bg-brand-gold px-5 py-2.5 font-bold text-white"><Plus className="h-5 w-5" />إضافة شريك</Link>} />
