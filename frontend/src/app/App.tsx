...
const NotFound = () => {
  ...
  return (
    <div className="bg-brand-navy min-h-screen">
      <PageHero title={t('הדף לא נמצא', 'Page not found')} />
      <section className="py-24 container mx-auto px-4 text-center">
        <p className="text-xl text-brand-silver mb-8">
          {t('העמוד שחיפשת אינו קיים.', 'The page you requested does not exist.')}
        </p>
        <a
          href="/"
          className="inline-flex rounded bg-brand-gold px-8 py-3 font-bold text-brand-navy transition-colors hover:bg-[#e3c458]"
        >
