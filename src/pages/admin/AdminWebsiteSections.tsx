...
import { Save, RefreshCw, Layers, CheckCircle, Globe, HelpCircle } from 'lucide-react';
...
export function AdminWebsiteSections() {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      ...
      setToast({
        show: true,
        msg: `✅ تم حفظ تعديلات قسم ${activeTab === 'about' ? 'من نحن' : 'تذييل الصفحة'} بنجاح! تم نشرها فوراً للموقع.`,
      });
  ...
  const resetToDefault = () => {
    if (confirm('إعادة تعيين المحتويات؟ سينتهي بك الأمر إلى حذف التخصيصات المخزنة.')) {
          ...
          <div className="max-w-5xl mx-auto space-y-8" dir={previewLocale === 'en' ? 'ltr' : 'rtl'}>
            ...
            <div className="grid md:grid-cols-3 gap-8 bg-[#112240] p-8 border border-white/5 rounded-xl">
              ...
              <div className="space-y-3">
                ...
                <EditableBlock
                  title="تعديل البريد الإلكتروني الرسمي لشركة أفق"
                  type="text"
