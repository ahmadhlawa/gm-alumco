...
See [BACKEND_ROADMAP.md](BACKEND_ROADMAP.md) for the proposed database schema, endpoint contract, security checklist, infrastructure options, and deployment phases.
